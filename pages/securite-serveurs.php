...
?>
<h1 class="text-2xl font-bold mb-6">Sécurité des serveurs</h1>

<div class="mb-4">
    <button class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded">
        🔁 Lancer une analyse sécurité complète
    </button>
</div>
...
<div class="overflow-x-auto bg-white shadow rounded-lg">
    <table class="min-w-full divide-y divide-gray-200">
        ...
        <tr>
            ...
            <th class="px-6 py-3 text-left text-sm font-bold uppercase">Vulnérabilités</th>
        ...
        <?php foreach ($serveurs as $srv): ?>
            <tr>
                ...
                <td class="px-6 py-4">
                    <span class="bg-yellow-100 text-yellow-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded">Audit à venir</span>
                </td>
                <td class="px-6 py-4">
                    <a href="<?= $baseUrl ?>pages/details-securite.php?id=<?= $srv['id'] ?>" class="text-blue-600 hover:underline text-sm">Voir détails</a>
                </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
