...
* detection des nouvelles versions depuis les tags GitHub quand aucune GitHub Release n'existe

## [1.4.0](https://github.com/grandpurs45/my-server-manager/compare/v1.3.1...v1.4.0) (2026-06-21)

### Features

* ajout de boutons de refresh cibles depuis la fiche cible pour supervision, patch management, cycle de vie OS et securite
* ajout d'un parametre MSM pour personnaliser le titre des onglets navigateur par environnement

## [1.3.1](https://github.com/grandpurs45/my-server-manager/compare/v1.3.0...v1.3.1) (2026-06-21)

### Bug Fixes

* rafraichissement automatique de l'OS inventorie apres une connexion SSH reussie
