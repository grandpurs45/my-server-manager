...
final class CheckCatalog
{
    public static function all(): array
    {
        return [
            ...
            [
                'name' => 'Supervision URLs',
                'unit' => 'msm-check-web',
                'description' => 'MSM HTTP and HTTPS URL monitoring',
                'timer_description' => 'Run MSM URL monitoring every minute',
                'settings_category' => 'web_monitoring',
                'interval_key' => 'check_interval_minutes',
                'interval_unit' => 'minutes',
                'cron' => '* * * * *',
                'log_stale_after_minutes' => 5,
